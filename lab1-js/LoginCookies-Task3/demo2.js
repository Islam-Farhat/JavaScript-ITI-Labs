...
{ 
      ...
      for(var i=0;i<arrCookies.length;i++)
      {
            ...
            {
                  if(arr[1]=="Male")
                    document.getElementById("img").setAttribute("src","./Images/WhatsApp Image 2023-01-08 at 12.02.20 PM (1).jpeg")
                  else
                    document.getElementById("img").setAttribute("src","./Images/WhatsApp Image 2023-01-08 at 12.02.20 PM.jpeg")
            }
